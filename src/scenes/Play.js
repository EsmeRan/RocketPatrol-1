class Play extends Phaser.Scene {
    ...
    create() {
        ...
        // green UI background
        //this.add.rectangle(0, borderUISize + borderPadding, game.config.width, borderUISize * 2, 0x0EA015).setOrigin(0, 0);
        ...
        // add turtle
        this.turtle1 = new Turtle(this, 300, 300, 'turtle', 0, 40).setOrigin(0, 0);
